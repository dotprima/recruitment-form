                ...
                <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
                    <div
                        ...
                        <div class="avatar avatar-xl avatar-online">
                            <img src="<?= !Auth::user()->images == null ? 'placeholder.png' : 'https://ui-avatars.com/api/?name=' . Auth::user()->name ?>"
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 avatar avatar-online me-3" data-bs-toggle="sidebar"
                                ...
                                <img class="user-avatar rounded-circle cursor-pointer"
                                    src="<?= !Auth::user()->images == null ? 'placeholder.png' : 'https://ui-avatars.com/api/?name=' . Auth::user()->name ?>"
                                    alt="Avatar" />
                            </div>
                                ...
                                <li class="chat-contact-list-item">
                                    <a class="d-flex align-items-center">
                                        ...
                                        <div class="chat-contact-info flex-grow-1 ms-2">
                                            <h6 class="chat-contact-name text-truncate m-0">{{ $item['name_bot'] }}</h6>
                                            <p class="chat-contact-status text-muted text-truncate mb-0">
                                                {{ $item['name_bot'] }}
                                            </p>
                                        </div>
                                        <small class="text-muted mb-auto">{{ $item['status'] }}</small>
                                    </a>
                                </li>
                    ...
                    <div class="chat-history-wrapper">
                                            ...
                                            <div class="d-flex overflow-hidden">
                                                ...
                                                <div class="user-avatar flex-shrink-0 ms-3">
                                                    <div class="avatar avatar-sm">
                                                        <img src="<?= !Auth::user()->images == null ? 'placeholder.png' : 'https://ui-avatars.com/api/?name=' . Auth::user()->name ?>" alt="Avatar"
                                                            class="rounded-circle" />
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="chat-history-footer shadow-sm">
                            <form class="form-send-message d-flex justify-content-between align-items-center">
                                <input class="form-control message-input border-0 me-3 shadow-none" name="messagecontent"
                                    id="messagecontent" placeholder="Type your message here" />
                                <div class="message-actions d-flex align-items-center">
                                    ...
                                    <button class="btn btn-primary d-flex send-msg-btn" id="messagecontentSubmit">
